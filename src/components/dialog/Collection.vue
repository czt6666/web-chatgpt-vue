<template>
    <div class="collect-box" :class="layout_mod ? 'moble' : ''" @click="modifyFavorites()">
        <div class="inner">
            <span class="star" :class="is_cur_session_favorited ? 'favor' : ''"></span>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            modifyFavorites() {
                ...
                this.$store.dispatch("moduleDialog/collectionsession", session_id);
            },
        },
    };
</script>
