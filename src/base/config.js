    ...
    install(Vue) {
        ...
        Vue.prototype.$config = {
            ...
            system: {
                ...
                tool: {
                    "变量命名": "请为我输入的变量命名，我会告诉你变量的用途，你要给变量取一个名字，使用下划线命名方式。在你的回答中，你必须用最少的话介绍清楚，不要说任何多余的字。",
                    "函数命名": "请为我输入的函数命名，我会告诉你函数的用途，你要给函数取一个名字，使用驼峰命名方式。在你的回答中，你必须用最少的话介绍清楚，不要说任何多余的字。",
                    "马克思哲学家": "我希望你充当马克思主义哲学家，我会为你提供一些哲学问题，你的工作是用马克思主义哲学来解释这些问题。你必须用精简的语言回答我，不要说多余的废话，一定要让回答读起来通俗易懂",
